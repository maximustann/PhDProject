...
ALG=GPHH
SETTINGS="/home/tanboxi/PH.D_project/containerAllocationConfigurationFiles/dynamic/GPHH_Probabilities"
CONTAINERNUM=2500
VMTYPES=$1
OSNUM=OS$2
DATASET=$3
...
java -cp GPHHStats.jar main.Main ./$SETTINGNAME.params $SEED

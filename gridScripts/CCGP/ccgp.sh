...
ALG=CCGP
SETTINGS="/home/tanboxi/PH.D_project/containerAllocationConfigurationFiles/dynamic/"
CONTAINERNUM=2500
VMTYPES=$1
OSNUM=OS$2
DATASET=$3
...
cp $JAR_PATH/ContainerAllocationCCGP.jar .
mkdir ./containerData
...
java -cp ContainerAllocationCCGP.jar main.Main ./$SETTINGNAME.params $SEED

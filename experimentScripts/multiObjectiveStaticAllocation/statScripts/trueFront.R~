...
cat("Usage: trueFront(numOfVm = 'ten', numOfApp=50)\n")
trueFront <- function(numOfVm='ten', numOfApp = 50){
	...
	path <- paste("../paretoFront/combinedFront/", numOfVm, "_app", numOfApp, ".csv", sep = '')
	front_filename <- paste("../paretoFront/trueFront/", numOfVm, "_app", numOfApp, ".csv", sep = '')

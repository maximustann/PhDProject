...
stableness <- function(base, run, numOfContainer){
	...
	ggsave(paste(base, "/slopeEvo_", run, ".png", sep=''), height=10, width=10)
	ggsave(paste(base, "/slopeEvo_", run, ".eps", sep=''), height=10, width=10)
